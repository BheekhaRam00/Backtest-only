// ================================================
// 🚀 SMART REGIME STRATEGY (V2 - STABLE + FILTERED)
...
function baseFilters(c) {
  ...
  if (atrNow < atrPrev * 0.7) return false; // low vol
  if (atrNow > atrPrev * 1.8) return false; // spike
